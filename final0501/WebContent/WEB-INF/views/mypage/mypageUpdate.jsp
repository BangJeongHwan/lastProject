...
<table class="list_table" style="width:1100px;" >
	...
	<tr>
		<td>아이디</td>
		<th colspan="2"><input type="text" name="id" id="_id" size="10" value="${company.cid }" readonly="readonly" style="border: 0"></th>
	</tr>
	...
	<tr>
		...
		<td>
			<table id="_updatePwd">
				<tr>
					<td>
						<input type="hidden" name="pwdch" id="_pwdch" value="${company.pwd }">
	...
	<tr>
		<td>회사 주소</td>
		<td><input type="text"size="30" value="${company.address }" readonly="readonly" style="border: 0"></td>
		<td>
	...
	<tr>
		<td>회사 전화번호</td>
		<th>
			<input type="text" size="20" value="${company.phone }" readonly="readonly" style="border: 0">
		</th>
	</tr>
	
	<tr>
		<td>회사 이메일</td>
		<th colspan="2"><input type="text" size="30" value="${company.email }" readonly="readonly" style="border: 0"></th>
	</tr>
	
	<tr>
		<td>사업자 등록증</td>
		<th colspan="2"><input type="text" size="30" value="${company.license }" readonly="readonly" style="border: 0"></th>
	</tr>
	
	<tr>
		<td colspan="3">
			<button type="button" id="_withdraw" onclick="withdrawCompany()">탈퇴 요청</button>
		</td>
