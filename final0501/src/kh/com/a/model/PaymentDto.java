...
//	편의상 추가
	...
	public String toString() {
		return "PaymentDto [payseq=" + payseq + ", mid=" + mid + ", grnum=" + grnum + ", pdseq=" + pdseq + ", option1="
				+ option1 + ", option2=" + option2 + ", option3=" + option3 + ", option4=" + option4 + ", option5="
				+ option5 + ", rvseq=" + rvseq + ", total_price=" + total_price + ", buydate=" + buydate + ", cposeq="
				+ cposeq + ", optionList=" + optionList + "]";
	}
